...
<svelte:head>
    {#if $page.data.title}
        <title>{$page.data.title} | Ears Tools by NickAc</title>
    {:else}
    ...
    <meta
        name="keywords"
        content="NickAc, NickAcPT, nmsr, minecraft, skin, render, avatar, blockbench, ears, mod, erase, region, model, generator"
    />
