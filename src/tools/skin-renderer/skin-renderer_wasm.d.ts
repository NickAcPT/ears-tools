...
export interface InitOutput {
  ...
  readonly wasm_bindgen__convert__closures__invoke1_mut__h051fc94a7d9ca10d: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke0_mut__h08a4108faf81fb74: (a: number, b: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h7888cbd042d6a423: (a: number, b: number, c: number) => void;
  readonly wasm_bindgen__convert__closures__invoke1_mut__h9613721940482ee8: (a: number, b: number, c: number) => void;
