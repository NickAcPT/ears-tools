...
export function wasm_bindgen__convert__closures__invoke1_mut__h79f9bd541e512bb1(a: number, b: number, c: number): void;
export function wasm_bindgen__convert__closures__invoke1_mut__h05fbe4ddf2759deb(a: number, b: number, c: number): void;
export function __wbindgen_free(a: number, b: number, c: number): void;
export function __wbindgen_exn_store(a: number): void;
export function wasm_bindgen__convert__closures__invoke2_mut__h0f7c3c3a9861f95d(a: number, b: number, c: number, d: number): void;
